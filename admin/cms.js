(function () {
  ...
  sidebar.innerHTML = `
    ...
    <div class="cms-sidebar__body">
      ...
      <div class="cms-accordion" data-accordion="wireframe">
        <button class="cms-accordion__header" type="button" aria-expanded="false">
          Wireframe
          <span class="cms-accordion__icon">+</span>
        </button>
        <div class="cms-accordion__panel">
          <button type="button" id="cms-wireframe-toggle" aria-pressed="false">Wireframe Off</button>
          <p class="cms-pill cms-pill--subtle">Toggle wireframe mode to rearrange elements.</p>
        </div>
      </div>
  ...
  const wireframeToggle = sidebar.querySelector('#cms-wireframe-toggle');
